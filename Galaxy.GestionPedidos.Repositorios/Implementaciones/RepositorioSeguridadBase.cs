...
public class RepositorioSeguridadBase<TEntity> : IRepositorioSeguridadBase<TEntity> where TEntity : EntitySeguridadBase
{
    protected readonly SeguridadDbContext Context;

    public RepositorioSeguridadBase(SeguridadDbContext context)
    {
        Context = context;
    }
